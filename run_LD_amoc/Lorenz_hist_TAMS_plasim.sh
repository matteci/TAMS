...
#SBATCH -o log_plasimhist.%j.o     # the name of the file where the standard output will be written to. %j will be the jobid determined by SLURM
#SBATCH -e log_plasimhist.%j.o     # the name of the file where potential errors will be written to. %j will be the jobid determined by SLURM
...
endblock=2500        # ultimo blocco: ti definisce lunghezza integrazione
...
expname=historical_ntraj${ntrajs}_LBlock${TotDaysBlock}_p${nparallel}_startID${startID}_years${inity}-${finaly}
