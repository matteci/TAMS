#!/bin/bash -l
#
#SBATCH -J testPlasim              # the name of your job   
...
#SBATCH -n 20               # the number of cores you want to use for the job, SLURM automatically determines how many nodes are needed
...
#### NAMELIST ##############################################################
nameThisFile='run_single_co2_amoc'
...
endblock=3000         # ultimo blocco: ti definisce lunghezza integrazione
...
ntrajsperbatch=1 # quante traiettorie ogni batch (diverso da batch sul filename che si riferisce a pool condizioni iniziali)
nbatches=1 # numero volte che devi integrare per finare # members
ntrajrest=0 # traiettorie in ultimo batch
...
mv ${scriptdir}/PLASIM-large-dev_0001.log ${expdir}/. ## COPIA FILE LOG DENTRO CARTELLA ESPERIMENTO
