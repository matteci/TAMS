...
mv /nethome/cini0001/PLASIM-TAMS/PLASIM_LSG_CO2-master/run_LD_amoc/PLASIM-large-dev-resample_45666.sh /nethome/cini0001/PLASIM-TAMS/PLASIM_LSG_CO2-master/AMOC_LD_amoc_pos_ntraj10_k0_LBlock360_p1_startIDl207-y2480_r2/scripts/PLASIM-large-dev-resample_${SLURM_JOB_ID}.sh
