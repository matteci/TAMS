...
resamplingname='TAMS_Matteo_scorefunction.py'   # file che fa il resampling
ntrajs=256
...
targetstate=9.4 #Sv
Ktmax=24 #number of max iteration before stopping. This is due only to sbatch capcity. NB: next time you re-run you have to change starting prob!
wp=0.09469163236252356 #starting prob
ktinit=20 #starting iteration of Tams, first iter =0
